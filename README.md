...
| **이름** | **전공** | **관심사** |
| --- | --- | --- |
| **양승일** | 소프트웨어학부 | 데이터직무, 인공지능 |
| **이우진** | 소프트웨어학부 | 의료, 백엔드, 인공지능 |
| **전지훈** | 소프트웨어학부 | UI/UX, 프론트엔드, 창업, 풀스택개발, 스타트업 |
| **우진** |  | |
...
### 팀 소개
우리 팀은 같은 소프트웨어학과에 재학 중이지만 각자 관심 분야와 앞으로의 진로가 다양한 팀입니다. 
은행 IT 직무, 공기업 및 의료계 관련 직무, 청각장애인을 위한 프로그램 개발과 창업 등 서로 다른 목표를 가지고 있습니다. 
각자의 방향은 다르지만 소프트웨어를 통해 자신이 하고 싶은 일을 만들어가고 있다는 공통점이 있습니다. 
또한 팀원 모두 음악을 좋아하며, 서로의 관심사와 진로에 대해 편하게 이야기하면서 가까워질 수 있었습니다. 
서로 다른 생각과 경험을 공유하며 함께 좋은 결과를 만들어가는 팀이 되고자 합니다. (편하게수정)
